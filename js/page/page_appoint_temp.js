							...
							+'<div class="main">'
								...
								+'<div class="dabbox ap_storeInfo">'
									...
									+'<div class="storeInfoMsg">'
										...
										+'{{if productInfo.deposit}}'
										+'<p id="deposit">定金：￥{{productInfo.deposit}}</p>'
										+'{{/if}}'
										+'{{if haveDesc}}'
										+'<p id="desc">{{productInfo.description}}</p>'
										+'{{/if}}'
									+'</div>'
								+'</div>'
								+'<div class="aptip">'
									+'{{if productInfo.deposit}}'
									+'<p>预约必读</p>'
									+'<p>本服务价格为 {{productInfo.price}}{{productInfo.qua}}</p><p>本店采用预支付模式，请先支付定金。在您提交预约单之后，我们会马上与您联系。</p>'
									+'{{/if}}'
									+'{{if haveDesc}}'
									+'<p>本服务价格为 {{productInfo.price}}{{productInfo.qua}}</p>'
									+'{{/if}}'
								+'</div>'
								+'<div class="dbox" style="padding-top:0px;">'
									+'<div class="form">'
										+'<div>'
											+'<span>姓名：</span>'
											+'<input id="name" type="text" placeholder="请输入姓名" maxlength="10"/>'
										+'</div>'
										+'<div>'
											+'<span>手机号：</span>'
								...
								+'<div class="blank"></div>'
									+'<div class="dabbox ap_storeInfo">'
										...
										+'<div class="storeInfoMsg">'
											...
											+'<p>预付定金：<span style="color:#1a1a1a">{{productInfo.deposit}}</span></p>'
										+'</div>'
								+'</div>'
								+'<div class="dbox" style="padding-top:0px;">'
									+'<div class="form">'
							...
							+'<div class="main">'
								...
								+'<div class="dabbox ap_storeInfo">'
									+'<div class="storeInfoImg">'
										...
										+'{{/if}}'
										+'{{if storeInfo.logo=="" }}'
										+'<img src="images/Default_Avater.jpg" alt="" class="s-head"/>'
										+'{{/if}}'
									+'</div>'
									+'<div class="storeInfoMsg">'
